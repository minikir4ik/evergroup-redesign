      ...
      <div className="max-w-2xl mx-auto px-6">
        ...
        <ScrollAnimation delay={0.1}>
          <div className="flex flex-col gap-6 mt-8 mb-12">
            <div>
              <p style={{ fontSize: "13px", textTransform: "uppercase", letterSpacing: "0.25em", fontWeight: 500, color: "#6abf4b", fontFamily: "var(--font-mono)" }}>Phone</p>
              <a href="tel:+97142160718" className="text-lg font-medium" style={{ color: "#ffffff" }}>+971 4 216 07 18</a>
            </div>
            <div>
              <p style={{ fontSize: "13px", textTransform: "uppercase", letterSpacing: "0.25em", fontWeight: 500, color: "#6abf4b", fontFamily: "var(--font-mono)" }}>Email</p>
              <a href="mailto:ask@evergroup.tech" className="text-lg font-medium" style={{ color: "#ffffff" }}>ask@evergroup.tech</a>
            </div>
            <div>
              <p style={{ fontSize: "13px", textTransform: "uppercase", letterSpacing: "0.25em", fontWeight: 500, color: "#6abf4b", fontFamily: "var(--font-mono)" }}>Address</p>
