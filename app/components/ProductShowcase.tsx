...
const products = [
  {
    ...
    bullets: ["50+ government and public data sources integrated", "Designed to support bank compliance workflows"],
    link: "/crc",
    mockup: <CRCMockup />,
  },
  {
    ...
    intro: "A payment infrastructure and app that helps contractors track orders and payment history and transfer money to cards or e-wallets.",
