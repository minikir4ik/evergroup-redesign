...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="py-16 lg:py-24 border-t" style={{ borderColor: "#2a2a2a", backgroundColor: "#0f0f0f" }}>
      <div className="max-w-2xl mx-auto px-6">
        ...
        <ScrollAnimation delay={0.1}>
          <div className="flex flex-col gap-6 mt-8 mb-12">
            <div>
              <p style={{ fontSize: "11px", textTransform: "uppercase", letterSpacing: "0.15em", color: "#6abf4b", fontFamily: "var(--font-mono)" }}>Phone</p>
              <a href="tel:+97142160718" className="text-lg font-medium" style={{ color: "#ffffff" }}>+971 4 216 07 18</a>
            </div>
            <div>
              <p style={{ fontSize: "11px", textTransform: "uppercase", letterSpacing: "0.15em", color: "#6abf4b", fontFamily: "var(--font-mono)" }}>Email</p>
              <a href="mailto:ask@evergroup.tech" className="text-lg font-medium" style={{ color: "#ffffff" }}>ask@evergroup.tech</a>
            </div>
            <div>
              <p style={{ fontSize: "11px", textTransform: "uppercase", letterSpacing: "0.15em", color: "#6abf4b", fontFamily: "var(--font-mono)" }}>Address</p>
          ...
          <ScrollAnimation delay={0.2}>
            <form onSubmit={handleSubmit} className="flex flex-col gap-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div>
                  <label htmlFor="name" className="text-sm font-medium" style={{ color: "#a0a0a0" }}>Name</label>
                  <input
                ...
                <div>
                  <label htmlFor="company" className="text-sm font-medium" style={{ color: "#a0a0a0" }}>Company</label>
                  <input
              ...
              <div>
                <label htmlFor="email" className="text-sm font-medium" style={{ color: "#a0a0a0" }}>Email</label>
                <input
              ...
              <div>
                <label htmlFor="message" className="text-sm font-medium" style={{ color: "#a0a0a0" }}>Message</label>
                <textarea
