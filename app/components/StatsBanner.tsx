          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-10 mt-12">
            {stats.map((stat, index) => (
              ...
              >
                ...
                <p className="mt-3" style={{ fontSize: "16px", fontWeight: 500, lineHeight: 1.8, color: "#b8b8b8" }}>{stat.label}</p>
                <p className="mt-1" style={{ fontSize: "13px", color: "#888888" }}>{stat.sub}</p>
              </div>
            ))}
          </div>
        </ScrollAnimation>
